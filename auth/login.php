    ...
    <div class="login-container">
        ...
        <div class="demo-credentials">
            <div class="demo-toggle" onclick="toggleDemo()">
                ...
                <span id="demoText">Show Demo Credentials</span>
            </div>
        ...
        <div class="student-interface-link">
            <a href="<?php echo BASE_PATH; ?>home/index.php" class="student-link">
                <i class="fas fa-graduation-cap"></i> Visit Student Interface
            </a>
        </div>
    </div>
    ...
    <script>
        function toggleDemo() {
            ...
            if (content.style.display === 'none') {
                ...
                text.innerHTML = 'Hide Demo Credentials';
            } else {
                content.style.display = 'none';
                text.innerHTML = 'Show Demo Credentials';
            }
        }
    </script>
</body>
